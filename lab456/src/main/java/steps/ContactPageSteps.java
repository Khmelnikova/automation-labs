...
public class ContactPageSteps extends Steps {
    ...
    public void isOnToAgentsPage(){
        Assert.assertTrue("title should be equal Агентам - БЕЛАВИА - Авиакомпания Республики Беларусь",
                driver.getTitle().equals("Агентам - БЕЛАВИА - Авиакомпания Республики Беларусь"));
    }
